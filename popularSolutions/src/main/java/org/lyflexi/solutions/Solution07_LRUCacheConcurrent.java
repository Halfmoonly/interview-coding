 ...
 */
public class Solution07_LRUCacheConcurrent {
    public static void main(String[] args) {
        Solution07_LRUCacheConcurrent instance = getInstance(3);
    }
    ...
    private static volatile Solution07_LRUCacheConcurrent solution07LruCacheConcurrent;

    public static Solution07_LRUCacheConcurrent getInstance(int capacity) {
        if (solution07LruCacheConcurrent == null) {

            synchronized (Solution07_LRUCacheConcurrent.class){
                //双重锁校验
                if (solution07LruCacheConcurrent == null) {
                    solution07LruCacheConcurrent = new Solution07_LRUCacheConcurrent(capacity);
                }
            }
    ...
    public Solution07_LRUCacheConcurrent(int capacity) {
